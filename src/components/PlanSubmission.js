...
const PlanSubmission = () => {
  ...
  <div className="flex flex-col items-start lg:items-end lg:ml-4">
    ...
    <div className="flex items-center mb-2">
      ...
      <p className="text-sm lg:text-base mb-5 font-semibold">Muhammed Riyas AV</p>
    </div>
    {/* Time Section */}
    <div className="flex items-center">
      <p className="text-xs -mt-11 mr-12 lg:text-xs text-gray-600">Started at: 10:00 AM</p>
    </div>
  </div>
</div>
  ...
  <div className="bg-white h-full p-4 rounded-xl flex items-center justify-between lg:justify-start w-full mt-4 lg:mt-0">
    ...
    <button className="bg-black text-white text-sm font-semibold px-6 py-2 rounded ml-5">
      View Analysis
    </button>
  </div>
  <div className="h-[27rem] w-full bg-white mt-3 p-4 rounded-xl shadow">
      <h2 className="text-black text-sm font-semibold">Process Timeline</h2>
      <p className="text-xs">
      ...
      <LeftPositionedTimeline />
        ...
        <div className="lg:w-[28%] mt-4 lg:mt-0 h-[28rem]">
          ...
          <div className="bg-white p-4 rounded-xl shadow h-full">
            ...
            <div className="bg-gray-200 w-7 h-7 max-w-1245:w-6 max-w-1245:h-6 rounded-full"><img
                src={image}
                alt="User"
                className="rounded-full w-8 h-8 mr-2"
              /></div>
